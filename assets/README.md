Assets stored here are basically locally stored versions of assets imported in this [demo](http://martinspier.io/d3-flame-graph/) ([source](https://github.com/spiermar/d3-flame-graph/blob/gh-pages/index.html))
